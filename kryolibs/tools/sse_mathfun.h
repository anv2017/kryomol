...
/* natural logarithm computed for 4 simultaneous float 
   return NaN for x <= 0
*/
inline static v4sf log_ps(v4sf x) {
#ifdef USE_SSE2
  v4si emm0;
#else
  v2si mm0, mm1;
...
inline static v4sf exp_ps(v4sf x) {
...
/* evaluation of 4 sines at onces, using only SSE1+MMX intrinsics so
   ...
   deliver full speed.
*/
inline static v4sf sin_ps(v4sf x) { // any x
...
inline static v4sf cos_ps(v4sf x) { // any x
...
inline static void sincos_ps(v4sf x, v4sf *s, v4sf *c) {
